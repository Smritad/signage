                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                          action="{{ route('aboutus-details.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control" id="editor" name="description" rows="5" placeholder="Enter Description" required></textarea>
                                        ...
                                        <!-- Preview -->
                                        <div class="col-xxl-4 col-sm-12" id="imagePreviewContainer" style="display:none;">
