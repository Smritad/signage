              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                   ...
                   <table class="display" id="basic-1"> <thead> <tr> 
...
<td>
    <a href="{{ route('stock-details.edit', $product->id) }}" class="btn btn-sm btn-primary mb-1">Edit</a>

    <!--<form action="{{ route('stock-details.toggle-status', $product->id) }}" method="POST" style="display:inline;">-->
    <!--    @csrf-->
