...
<div class="container-fluid">
    ...
    <div class="page-heading">
        <div>
            <h4>Create Offer</h4>
            <div class="subtitle">Build a new bundle offer with flexible product slots.</div>
        </div>
        <ol class="breadcrumb">
    ...
    <form action="{{ route('offer-details.store') }}" method="POST" id="offerForm" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="products"         id="productsJson">
    <input type="hidden" name="offer_price_type" id="offerPriceType" value="{{ old('offer_price_type','fixed') }}">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card-clean">
                <div class="card-clean__header">
                    <h5>Offer Details</h5>
                    <p>Fill in the name, pricing, images and product slots for this bundle.</p>
                </div>
                <div class="card-clean__body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="offer_name" class="form-control"
                                       value="{{ old('offer_name') }}" placeholder="e.g. Sandalwood Perfume Bundle" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div id="percentPriceWrap" style="display:none;">
                                    <div class="d-flex">
                                        <input type="number" name="offer_discount_percent" id="offerDiscountInput"
                                               ...
                                               value="{{ old('offer_discount_percent') }}">
                    ...
                    <div class="section-block">
                        ...
                        <div class="section-hint">Optional banner and product image for the storefront.</div>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Banner Image</label>
                                <div class="img-upload">
                                    <input type="file" name="banner_image" accept="image/jpeg,image/png,image/webp"
                                           onchange="previewImage(this,'bannerPreview','bannerFilename','banner')">
                                    ...
                                    <span class="img-upload__title">Click to upload banner</span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="img-upload">
                                    <input type="file" name="offer_image" accept="image/jpeg,image/png,image/webp"
                                           onchange="previewImage(this,'offerPreview','offerFilename','offer')">
                                    <span class="img-upload__icon">
                                    ...
                                    <span class="img-upload__title">Click to upload offer image</span>
                                    <span class="img-upload__hint">JPG, PNG or WEBP</span>
        ...
        <div class="col-lg-4">
            <div class="card-clean summary-card">
                <div class="card-clean__header">
                    <h5>Live Summary</h5>
                    <p>Auto-updates as you configure.</p>
                </div>
                <div class="card-clean__body">
                    ...
                    <div class="summary-block">
                        ...
                        <div id="summaryProducts"><span class="empty-text">No slots yet</span></div>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-save flex-grow-1">Create Offer</button>
...
const OFFER_PRICE_TYPE_SAVED = '{{ old('offer_price_type','fixed') }}';
...
/* ══════════════════════════════════════════════════════
   IMAGE PREVIEW
══════════════════════════════════════════════════════ */
function previewImage(input, previewId, filenameId, thumbType) {
...
function buildProductOptionsForCategory(catId) {
    let html = '';
    ALL_PRODUCTS.filter(p => String(p.category_id) === String(catId)).forEach(p => {
        html += `<option value="${p.id}">${escHtml(p.product_name)}</option>`;
    });
    return html;
}
            ...
            <div class="col-12 slot-pinned-wrap" id="pinnedWrap${i}"
                ...
                <div class="slot-section">
                    ...
                    <div class="pinned-note">
                        ...
                        Choose a category first, then pin the specific products the customer will pick from. Great for "Choose 1 of Nebula / Altair / Aquila / Kepler".
                    </div>
                    <div class="row g-3 mt-1">
                        <div class="col-md-5">
                            <label class="form-label">Category</label>
                        ...
                        <div class="col-12">
                            ...
                            <div class="hint">Only the products you pin here will be shown to the customer.</div>
                        </div>
                    </div>
                </div>
            </div>
...
/* ── Repopulate pinned product dropdown based on selected category + units ── */
