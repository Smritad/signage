 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="icon" href="{{ asset('admin/assets/images/logo/logo.webp') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('admin/assets/images/logo/logo.webp') }}" type="image/x-icon">
    <title>Signage</title>
    <!-- Google font-->
