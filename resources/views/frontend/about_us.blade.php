        ...
        <div class="container">
          <div class="content">
            ...
            <ul class="breadcrumbs-page">
              ...
              <li>
                <h6 class="current-page fw-normal">About Us</h6>
              </li>
            </ul>
          </div>
        </div>
...
<div class="about-us-page flat-spacing">
  <div class="container">
    <div class="row align-items-center">
      ...
      <!-- Image -->
      <div class="col-md-6">
        <div class="about-page-img wow fadeInLeft">
          <img src="{{ asset('signage/home/productimage/' . $about->image) }}" 
               alt="{{ $about->title }}" class="img-responsive">
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="about-page-text">
          <div class="sect-title wow fadeInRight">
            <p class="s-title h1 fw-medium mb-8">{{ $about->title }}</p>
          </div>
